    ...
    <div className="min-h-screen bg-gray-50 text-center">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-5 w-full mb-8 bg-gray-200 p-1">
            <TabsTrigger
              value="overview"
              className="flex flex-col items-center gap-1 py-2.5 px-4 text-center data-[state=active]:bg-white data-[state=active]:shadow-sm"
            >
            ...
            <TabsTrigger
              ...
              className="flex flex-col items-center gap-1 py-2.5 px-4 text-center data-[state=active]:bg-green-50 data-[state=active]:shadow-sm data-[state=active]:text-green-800"
            >
                ...
                <div className="lg:col-span-2">
                  <Card className="border shadow-sm">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Explore degrees based on your APS score and subject
                        choices
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        {filteredDegrees.length === 0 ? (
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 mb-4">
                              Try adjusting your filters or increasing your APS
                              score.
                            </p>
                            <Button variant="outline" onClick={clearFilters}>
                              Clear Filters
                        ...
                        <AccordionItem value="calculation">
                          ...
                          <AccordionContent>
                            <p className="text-sm text-gray-600">
                              APS (Admission Point Score) is calculated by
                              converting your final matric marks to points:
                              80-100% = 7 points, 70-79% = 6 points, 60-69% = 5
                              points, 50-59% = 4 points, 40-49% = 3 points,
                        ...
                        <AccordionItem value="universities">
                          ...
                          <AccordionContent>
                            <p className="text-sm text-gray-600">
                              ...
                              different universities may have specific
                              requirements for certain programs, including
                              minimum scores for particular subjects.
                            </p>
                          </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value="other-factors">
                          ...
                          <AccordionContent>
                            <p className="text-sm text-gray-600">
                              ...
                              aptitude tests, and other admission criteria
          ...
          <TabsContent value="bursaries" className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Bursary Explorer</h2>
          ...
          <TabsContent value="books" className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Campus Books</h2>
              <p className="text-gray-600">Find textbooks for your courses</p>
            </div>
          </TabsContent>

          <TabsContent value="accommodation" className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Student Accommodation</h2>
