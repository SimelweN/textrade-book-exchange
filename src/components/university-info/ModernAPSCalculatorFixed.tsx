...
// Sample subjects with good marks for demonstration
...
const ModernAPSCalculatorFixed: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <Tabs
              ...
              onValueChange={(value) =>
                setActiveInsight(
                  value as "overview" | "universities" | "programs",
                )
              }
              className="w-full"
            >
...
export default ModernAPSCalculatorFixed;
