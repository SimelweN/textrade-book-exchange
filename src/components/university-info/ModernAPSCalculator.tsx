...
const ModernAPSCalculator: React.FC = () => {
  ...
  const stats = useMemo(() => {
    ...
    const eligibilityRate = totalDegrees > 0 ? Math.round((eligibleCount / totalDegrees) * 100) : 0;
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Advanced admission point score analysis with comprehensive university matching and career pathway insights.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <Tabs
              value={activeInsight}
              onValueChange={(value) => setActiveInsight(value as 'overview' | 'universities' | 'programs')}
              className="w-full"
            <Tabs value={activeInsight} onValueChange={(value) => setActiveInsight(value as any)} className="w-full">
                  ...
                  <Card className="bg-white border-0 shadow-lg">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-slate-600">Eligible Programs</span>
                          <span className="text-xl font-bold text-emerald-600">{stats.eligibleCount}</span>
                        </div>
                        <div className="pt-2">
                          <div className="flex justify-between text-sm mb-2">
                            <span className="text-slate-600">Eligibility Rate</span>
                            <span className="font-medium">{stats.eligibilityRate}%</span>
                          </div>
                          <Progress value={stats.eligibilityRate} className="h-3" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <Card className="bg-white border-0 shadow-lg">
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between text-slate-900">
                      ...
                      <Badge variant="outline">{filteredDegrees.length} results</Badge>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {filteredDegrees.map((degree, index) => (
                        <div key={index} className="p-4 border border-slate-200 rounded-lg hover:shadow-md transition-shadow">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-sm">
                            ...
                            <Button size="sm" variant="ghost" className="text-blue-600 hover:text-blue-700 w-full sm:w-auto justify-center sm:justify-start">
                              View Details
